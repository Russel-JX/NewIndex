...
<html>
  <head>
    ...
    <title>index_name_l2.jsp 2级指标名称维护</title>
	...
	<script type="text/javascript">
		Ext.onReady(function() {
			...
			var l2UpdColumns = [ 
				...
				{header:"一级指标名称",width:100,dataIndex:"parentId",renderer:getUpL1Name},
				{header : "二级指标名称",width : 150,dataIndex : "zbName",sortable : true,
			...
			function getUpL1Name(value,metadata,record,rowIndex,colIndex,view){
				return (l2_1UpdStore.findRecord("id",value,0,true,false,false)).get("zbName");
			}
			//获取要修改的三级指标
			function getUpdThree() {
				...
				var newUrl = "threeqtwoAction!.do?date=" + dateFormat;
								...
								l2UpdStore.load({
									...
									callback : function(records, operation, success) {
										...
										if (Ext.getCmp("l2UpdGrid") == null) {
											...
											inUpdForm.remove(Ext.getCmp("l2UpdGrid"));
											inUpdForm.add(
											//创建表格
											Ext.create("Ext.grid.Panel", {
												title : "维护二级指标（修改、删除）",
