//注册复选框选择模式的别名
			...
			//创建表格
			var usMatForm = Ext.create("Ext.grid.Panel",{
				title:"用户维护",
				id:"usMatForm",
			...
			//删除用户
			function removeUser(){
				var rows = usMatForm.getSelectionModel().getSelection();//获取所选的多行记录,数组类型
